...
const UserTable = () => {
  ...
  return (
    ...
    <div className='w-[700px] min-h-[200px] shadow-md ' >
        ...
        <tbody className=''>
            {filteredData.slice(0,rows).map((d,index)=>(
    ...
    <div className='flex gap-3 mb-5'>
        <p>rows per page</p>
        <select name="" id="" onChange={(e)=>setRows(e.target.value)}>
        ...
        <p>page</p>
        <div className='bg-blue-500 text-white px-3 py-1'>prev</div>
        <div className='bg-blue-500 text-white px-3 py-1'>1</div>
        <div className='bg-blue-500 text-white px-3 py-1'>next</div>
      </div>
    </div>
  )
}
